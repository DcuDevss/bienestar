...
class PatientDate extends Component
{
    ...
    public function getIntervalo($start, $end)
    {
        $appoinments = Appoinment::where('date', $this->date)
            ...
            ->pluck('hora_id')->toArray();//con esto tenemos un array de id que son las horas q asu ves represtean los intervalos q tenemos reservados como citas son slos id de citas
