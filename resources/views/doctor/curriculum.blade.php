    ...
    <div class="container mx-auto max-w-5xl p-6">
        ...
        <div class="grid grid-col-1 md:grid-cols-3 gap-3">
            <div class="max-w-sm rounded overflow-hidden shadow-lg">
                ...
                <div class="px-6 py-4">
                    <div class="font-bold text-xl mb-2 capitalize">{{ __('especialidades') }}</div>
            ...
            <div class="max-w-sm rounded overflow-hidden shadow-lg">
               ...
               @livewire('social.social-create')
                <div class="px-6 py-4">
                    <div class="font-bold text-xl mb-2 capitalize">{{ __('Medios de comunicacion') }}</div>
                    <p class="text-gray-700 text-base">
            ...
            <div class="max-w-sm rounded overflow-hidden shadow-lg">
               ...
               {{--  @livewire('skill.skill-create') --}}
                <div class="px-6 py-4">
                    <div class="font-bold text-xl mb-2 capitalize">{{ __('habilidades') }}</div>
                    <p class="text-gray-700 text-base">
