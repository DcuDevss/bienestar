            ...
            <div class="flex">
                ...
                <div class="hidden sm:-my-px sm:ml-10 sm:flex" x-data="{ open: false }">
                    <div class="relative mt-5">
                        ...
                        <!-- Dropdown Menu -->
                        <div x-show="open" @click.away="open = false" class="absolute z-10 right-0 mt-9 w-48 bg-white border border-gray-300 rounded-md shadow-lg">
                            <!-- Enlace a Pacientes -->
                            <a href="{{ route('dashboard') }}" class="block text-sm text-gray-800 hover:bg-slate-300 px-4 py-2 m-0">
                                <i class="fa-solid fa-user-injured w-4 mr-2"></i> Pacientes Activos
                            </a>
                            ...
                            <a href="{{ route('patient.patient.patient-entrevistas') }}" class="block text-sm text-gray-800 hover:bg-slate-300 px-4 py-2 m-0">
                                <i class="fa-solid fa-list-check w-4 mr-2"></i> Entrevistas
                            </a>
                            
                            <!-- NUEVO ENLACE: Pacientes Eliminados (Papelera) -->
                            <a href="{{ route('pacientes.eliminados') }}" class="block text-sm text-gray-800 hover:bg-red-300 px-4 py-2 m-0 border-t border-gray-200 mt-1 pt-1">
                                <i class="fa-solid fa-trash-can w-4 mr-2 text-red-600"></i> Pacientes Eliminados
                            </a>
