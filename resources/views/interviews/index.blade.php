                    ...
                    <div>
                        <div class="bg-white p-3 rounded-md">
                            ...
                            <div class="image overflow-hidden flex items-center justify-center">
                                ...
                                @else
                                    <img class="h-[200px] w-[200px] object-cover rounded-full shadow-md"
                                        src="{{ asset('assets/defaultPicture.jpg') }}" alt="Foto por defecto">
                                @endif
                            </div>
                            ...
                            <ul class="bg-gray-300 rounded mt-1 px-3 py-1 text-gray-500">
                                <li class="flex items-center py-1 capitalize">
                                    ...
                                    <span class="ml-auto text-white px-2 py-1 text-sm rounded">
                                        ...
                                        @else
                                            <span class="px-2 py-1 rounded-md bg-slate-200 text-slate-700">Sin
                                                estado</span>
                                        @endif
                                    </span>
                                </li>
                ...
                <div class="col-span-1 md:col-span-9 bg-white rounded-xl p-6 md:p-8 shadow-sm">
                    ...
                    <dl class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-x-6 gap-y-2 text-sm">
                        ...
                        <div class="border-b border-slate-100 pb-1">
                            ...
                            <dd class="font-semibold text-slate-800 capitalize">{{ $paciente->jerarquias ? $paciente->jerarquias->name : 'Sin jerarquía'  }}</dd>
                        </div>
                        ...
                        <div class="border-b border-slate-100 pb-1">
                            ...
                            <dd class="font-semibold text-slate-800 capitalize">{{ $paciente->estados?->name ?? 'Sin estado' }}</dd>
                        </div>
                        ...
                        <div class="border-b border-slate-100 pb-1">
                            ...
                            <dd class="font-semibold text-slate-800">
                                {{ $fechaAtencion ? \Carbon\Carbon::parse($fechaAtencion)->format('d-m-Y H:i:s') : 'Sin fecha' }}
                            </dd>
