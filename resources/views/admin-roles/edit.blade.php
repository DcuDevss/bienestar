            ...
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                ...
                <div class="mb-4 ">
                    <form action="{{ route('admin-roles.update', $role) }}" method="post"
                        class="shadow-lg border w-fit mx-auto py-5 px-10">
                        @method('put')
                        @csrf
                        ...
                        {{-- <div class="mb-4 w-fit mx-auto">
                            ...
                            <input name="name"
                                class="bg-gray-200 appearance-none border-2 border-gray-200 rounded py-2 px-4 text-gray-700 leading-tight focus:outline-none focus:bg-white focus:border-purple-200"
                                id="inline-full-name" type="text" value="{{ $role->name }}">
                        </div> --}}


                        <div class="grid grid-cols-2 w-fit mx-auto gap-x-12">
                            <h1 class="text-blue-800"><strong>Lista de Permisos para: 
