            ...
            <div class="bg-white shadow-lg rounded-lg p-6">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                    <div class="col-span-1">
                        ...
                        <input type="text" id="apellido_nombre" wire:model="apellido_nombre"
                    ...
                    <div class="col-span-1">
                        ...
                        <input type="number" id="TelefonoCelular" wire:model="TelefonoCelular"
                            class="input rounded-md w-full">
                    </div>
            ...
            <div class="bg-white shadow-lg rounded-lg p-6">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 mt-4">
                    ...
                    <div class="col-span-1">
                        ...
                        <input type="text" id="destino_actual" wire:model="destino_actual"
                            class="input rounded-md w-full">
                    </div>
                    ...
                    <div class="col-span-1">
                        ...
                        <input type="number" id="NroCredencial" wire:model="NroCredencial"
                            class="input rounded-md w-full">
                    </div>
