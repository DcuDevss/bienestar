                ...
                @foreach ($enfermedades as $disase)
                    <ul class="max-w-[22%] h-auto relative shadow-2xl rounded-md px-5 py-5 mx-auto text-[14px]">
                        ...
                        <div class="bottom-2 pt-2 flex justify-center w-full absolute">
                            <button wire:click="editModalDisase({{ $disase->id }}, {{ $disase->pivot->id }})">Editar</button>
    ...
    <x-slot name="content">
        <div class="grid grid-cols-2 gap-4">
            ...
            <div>
                ...
                <input id="horas_salud" type="number" class="w-full rounded"
                       wire:model.defer="horas_salud" />
            ...
            <div>
                ...
                <input id="suma_salud" type="number" class="w-full rounded"
                       wire:model.defer="suma_salud" />
            ...
            <div class="col-span-2 grid grid-cols-2 gap-4">
                ...
                <div>
                    ...
                    <input id="imagen_dorso" type="file" class="rounded py-2"
                           wire:model.defer="imagen_dorso" accept="image/*" />
            ...
            <div class="col-span-2">
                ...
                <textarea id="detalle_certificado" rows="5" class="w-full rounded"
                          wire:model.defer="detalle_certificado"></textarea>
