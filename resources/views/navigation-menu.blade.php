        ...
        <div class="flex justify-between h-16">
            <div class="flex items-center"> <div class="shrink-0 flex items-center">
                    <a href="{{ route('dashboard') }}">
                        <x-application-mark class="block h-9 w-auto" /> </a>
                </div>

                <div class="hidden sm:-my-px sm:ml-10 sm:flex space-x-4"> <div class="relative flex items-center" x-data="{ open: false }">
                        <button @click="open = !open"
                            class="inline-flex items-center px-4 py-2 bg-orange-500 border border-transparent rounded-md font-semibold text-sm text-white uppercase tracking-widest hover:bg-orange-600 focus:outline-none focus:ring-2 focus:ring-orange-500 focus:ring-offset-2 transition ease-in-out duration-150">
                            Seleccionar
                            <svg x-bind:class="{ 'rotate-180': open }"
                                class="w-4 h-4 ml-2 transform transition-transform ease-in-out duration-200"
                        ...
                        <div x-show="open" @click.away="open = false"
                            class="absolute z-50 mt-2 top-full right-0 w-36 bg-white border border-gray-200 rounded-md shadow-xl origin-top-right">
                            <a href="{{ route('dashboard') }}"
                                class="block text-sm text-gray-700 hover:bg-gray-100 px-4 py-2 transition duration-150 ease-in-out">
                                Pacientes
                            </a>
                    ...
                    <div class="relative flex items-center" x-data="{ open: false }">
                        <button @click="open = !open"
                            class="inline-flex items-center px-4 py-2 bg-gray-700 border border-transparent rounded-md font-semibold text-sm text-white uppercase tracking-widest hover:bg-gray-800 focus:outline-none focus:ring-2 focus:ring-gray-700 focus:ring-offset-2 transition ease-in-out duration-150">
                            General
                            <svg x-bind:class="{ 'rotate-180': open }"
                                class="w-4 h-4 ml-2 transform transition-transform ease-in-out duration-200"
                                fill="none" stroke="currentColor" viewBox="0 0 24 24"
                        ...
                        <div x-show="open" @click.away="open = false"
                            class="absolute z-50 mt-2 top-full right-0 py-1 w-36 bg-white border border-gray-200 rounded-md shadow-xl origin-top-right">
                            
                            @can('disases.index')
                                <a href="{{ route('disases.index') }}"
                                    class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 transition duration-150 ease-in-out">Enfermedades</a>
                            @endcan
                            <a href="{{ route('multiform.index') }}"
                                class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 transition duration-150 ease-in-out">Formulario</a>
                            @role('super-admin')
                                <a href="{{ route('auditorias.index') }}"
                                class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 transition duration-150 ease-in-out">Auditorías</a>
                            @endrole
                        </div>
                    </div>
                </div>
