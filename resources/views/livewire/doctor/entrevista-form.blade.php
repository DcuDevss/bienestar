            ...
            <div id="collapseOne" class="collapse-content p-4 hidden">
                ...
                <div x-data="{
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                            ...
                            <select x-model="tipo_entrevista_id" class="mt-1 p-2 w-full border rounded-md">
                                ...
                                @foreach ($tipos_entrevista as $tipo)
                                    <option value="{{ $tipo->id }}"
                                        @if ($tipo_entrevista_id == $tipo->id) selected @endif>
                                        {{ $tipo->name }}
                                    </option>
                                @endforeach
                            </select>
                        ...
                        <div x-show="" class="mb-4">
                            <label for="motivo_causas_judiciales" class="block text-sm font-medium text-gray-700">Motivo
                                de
                        ...
                        <div x-show="" class="mb-4">
                            <label for="sosten_de_familia" class="block text-sm font-medium text-gray-700">¿Sos sosten
                                de
                                Familia?</label>
                        ...
                        <div x-show="tipo_entrevista_id == 1" class="mb-4">
                ...
                <div class="mb-4">
                    ...
                    <div class="mt-4 flex justify-start">
                        <button type="button" wire:click="addMember"
                            class="text-white bg-blue-500 p-2 rounded w-auto">
                            Agregar Miembro
                        </button>
                    </div>
                </div>
                    ...
                    @foreach ($miembros as $index => $miembro)
                        <li>
                            ...
                            <button type="button" wire:click="removeMember({{ $index }})"
                                class="px-2 mb-2 ml-2 text-center bg-red-500 text-white rounded-md shadow-md hover:bg-red-600 focus:outline-none">
                                X
                            </button>
                        </li>
                    @endforeach
        ...
        <div class="bg-white shadow-md rounded-lg mb-4 mx-auto px-4 w-9/12">
            ...
            <div id="collapseThree" class="collapse-content p-4 hidden">
                ...
                <div x-data="{ tipo_entrevista_id: @entangle('tipo_entrevista_id') }">
                    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                        <div class="mb-4">
                            <label for="enfermedad_preexistente"
                                class="block text-sm font-medium text-gray-700">¿Posee
                                alguna
                        ...
                        <div class="mb-4">
                            <label for="medicacion"
                                class="block text-sm font-medium text-gray-700">Medicamentos:</label>
                        ...
                        <div class="mb-4">
                            <label for="profesional" class="block text-sm font-medium text-gray-700">Profesional que
                                lo
                                atendió</label>
                        ...
                        <div class="mb-4">
                            <label for="medicacion_recetada"
                                class="block text-sm font-medium text-gray-700">Medicación
                        ...
                        <div class="mb-4">
                            <label for="cantidad_fuma" class="block text-sm font-medium text-gray-700">Cantidad por
                                día:</label>
                        ...
                        <div class="mb-4">
                            <label for="horas_dormir" class="block text-sm font-medium text-gray-700">Cuántas horas
                                duerme
                                por
                                día?</label>
                        ...
                        <div class="mb-4">
                            <label for="horas_suficientes" class="block text-sm font-medium text-gray-700">Son
                                Suficientes
                                las
                        ...
                        <div class="mb-4">
                            <label for="estado_entrevista_id" class="block text-sm font-medium text-gray-700">Estado
                                de la
                                Entrevista:</label>
                        ...
                        <div x-show="!(tipo_entrevista_id == 2 || tipo_entrevista_id == 3 || tipo_entrevista_id == 4 || tipo_entrevista_id == 6 || tipo_entrevista_id == 7 || tipo_entrevista_id == 10 || tipo_entrevista_id == 11)"
                            ...
                            <label for="evolucion_tratamiento"
                                class="block text-sm font-medium text-gray-700">Evolucion
                                Tratamiento:</label>
                        ...
                        <div x-show="!(tipo_entrevista_id == 1 || tipo_entrevista_id == 2 || tipo_entrevista_id == 3 )"
                            class="mb-4">
                            <label for="portacion_id" class="block text-sm font-medium text-gray-700">Portación de
                                armamento:</label>
                        ...
                        <div x-show="!(tipo_entrevista_id == 1|| tipo_entrevista_id == 2 || tipo_entrevista_id == 3 || tipo_entrevista_id == 4 )"
                            class="mb-4">
                            <label for="recomendacion" class="block text-sm font-medium text-gray-700">Se recomienda
                                realizar/continuar tratamiento:</label>
