...
class KinesiologiaForm extends Component
{
    ...
    {
        // ESTE ES EL LOG IMPORTANTE DE INICIO DE PROCESO
        ...
        try {
            ...
            // ESTE ES EL LOG IMPORTANTE DE FINALIZACIÓN EXITOSA
            Log::info("✅ FINALIZADO. Ficha guardada correctamente", ['ficha_id' => $this->ficha->id]);
            ...
            // En saveFichaKinesiologica()
        } catch (\Illuminate\Validation\ValidationException $e) {
            $msg = collect($e->validator->errors()->all())->implode(' | ');
            $msg = (string) $msg; // aseguramos que sea string

            $this->dispatch('swal', [
                'title' => 'Revisá los campos',
                'text' => is_array($msg) ? implode(' | ', $msg) : $msg, // <--- ESTA LÍNEA ES REDUNDANTE Y CAUSA EL PROBLEMA
                'icon' => 'error',
                'timer' => 5000
            ]);
            throw $e;
            ...
            // ESTE ES EL LOG IMPORTANTE DE ERROR CRÍTICO
