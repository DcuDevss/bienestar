<div>
    ...
    <div class="bg-white p-3">
        ...
        <ul class="w-full">
            @forelse($enfermedades as $enfermedad)
                <li class="cursor-pointer px-3 py-2 bg-gray-400 hover:bg-gray-500 text-black my-2 bolck">
                    <a
                ...
                @if (strlen(trim($this->search)) > 4)
                    ...
                    <div class="bg-blue-500 text-white text-center p-2 my-2">
                        <button wire:click="addNew">
                            {{ __('¿Quieres agregar esta nueva enfermedad?') }}
                            <br>
                            <strong class="text-xl">{{ __($this->search) }}</strong>
                            <br>
                            <p>{{ __('Listar ...?') }}</p>
    ...
    @if ($modal)
        <div class="bg-gray-800 bg-opacity-65 fixed  inset-0 ">
            <div class="p-12">
