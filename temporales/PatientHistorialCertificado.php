...
class PatientHistorialCertificado extends Component
{
    ...
    $disase_id, $patient_disases, $patient, $disase;
...
{
    // Obtén los pacientes con sus enfermedades y registros asociados paginados
    $pacientes = Paciente::with(['disases' => function ($query) {
