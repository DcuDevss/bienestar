                    ...
                    <table class="w-full text-left text-gray-400">
                        ...
                        <tbody>
                            @forelse ($pacientesEliminados as $paciente)
                                <tr wire:key="deleted-{{ $paciente->id }}" class="border-b border-gray-700 hover:bg-[#204060]">
                                    <td class="px-4 py-1 text-[14px] font-medium text-white">{{ $paciente->apellido_nombre }}</td>
                                    ...
                                    <td class="px-2 py-1 text-[14px]">
                                        @if ($paciente->estado_id == 1)
                                            <span class="bg-green-600 text-white rounded-md px-4 py-1 inline-block">{{ $paciente->estados->name }}</span>
                                        @elseif ($paciente->estado_id == 2)
                                            <span class="bg-gray-600 text-white rounded-md px-4 py-1 inline-block">{{ $paciente->estados->name }}</span>
                                        @elseif ($paciente->estado_id == 3)
                                            <span class="bg-yellow-400 text-black rounded-md px-4 py-1 inline-block">{{ $paciente->estados->name }}</span>
                                        @elseif ($paciente->estado_id == 4)
                                            <span class="bg-red-700 text-white rounded-md px-4 py-1 inline-block">{{ $paciente->estados->name }}</span>
                                        @elseif ($paciente->estado_id == 5)
                                            <span class="bg-black text-white rounded-md px-4 py-1 inline-block">{{ $paciente->estados->name }}</span>
                                        @endif
                                    </td>
                                    ...
                                    <td class="px-4 py-1 text-[14px] text-center">
                                        ...
                                        ">
                                            ...
                                            <button
                                                ...
                                                "
                                                class="ml-2 px-3 py-1 text-[12px] bg-gray-600 hover:bg-gray-500 text-white rounded">
                                                Restaurar
                                            </button>
                                            ...
                                            @role('super-admin')
                                                <button
                                                    ...
                                                    "
                                                    class="ml-2 px-3 py-1 text-[12px] bg-red-700 hover:bg-red-600 text-white rounded">
                                                    Borrar
                                                </button>
                                            @endrole
                                        </div>
