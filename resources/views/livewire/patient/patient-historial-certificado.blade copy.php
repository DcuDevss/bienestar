            ...
            <div class="grid grid-cols-2 gap-4">
                ...
                <div>
                    ...
                    <input id="fecha_finalizacion_licencia" class="w-full rounded" type="datetime-local"
                        placeholder="{{ __('fecha finalización') }}"
                ...
                <div>
                    <label for="suma_salud"
                        class="block text-sm font-medium text-gray-700">{{ __('Dias licencia') }}</label>
                    <input id="suma_salud" class="w-full rounded cursor-pointer" type="number"
                        placeholder="{{ __('ingrese dias certificado') }}" wire:model.defer="suma_salud" />
                ...
                <div class="col-span-2 grid grid-cols-2 gap-4">
                    <div>
                        <label for="imagen_frente"
                            class="block text-sm font-medium text-gray-700">{{ __('Frente certificado') }}</label>
                        <input id="imagen_frente" class="rounded py-2" type="file"
                            wire:model.defer="imagen_frente" accept="image/*" />
                        <x-input-error for="imagen_frente" />
                    </div>
                    <div>
                        <label for="imagen_dorso"
                            class="block text-sm font-medium text-gray-700">{{ __('Dorso certificado') }}</label>
